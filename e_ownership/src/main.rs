fn main() {
    ...
    let (product_of_nums, numbers2) = product(numbers); // 👉 TODO call product() and put answer here
    let average_of_nums = average(numbers2); // 👉 TODO call average() and put answer here
